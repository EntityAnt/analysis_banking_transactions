...
from src.views import get_all_expenses, get_greeting, get_top_n_transactions
...
def test_get_all_expenses(get_test1_df: pd.DataFrame, get_empty_df: pd.DataFrame) -> None:
...
def test_get_top_n_transactions(get_full_df: pd.DataFrame, get_empty_df: pd.DataFrame, result_for_top_n: list) -> None:
