...
from src.utils import get_start_end_month, round_to_limit, get_data_from_excel, transactions_from_df
...
def test_transactions_from_df(get_test1_df: pd.DataFrame, get_empty_df: pd.DataFrame) -> None:
    ...
    assert transactions_from_df(get_test1_df) == [{'Дата операции': '2018-01-17', 'Сумма операции': -210},
