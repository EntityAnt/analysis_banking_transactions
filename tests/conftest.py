...
def result_for_top_n() -> list:
    return [
        ...
        {"amount": 5000.0, "category": "Бонусы", "date": "06.06.2021", "description": "Компенсация покупки"},
        {
            "amount": 1100.0,
            "category": "Пополнения",
            "date": "06.06.2021",
        ...
        {"amount": 191.3, "category": "Бонусы", "date": "16.06.2021", "description": "Проценты на остаток"},
        {
            "amount": 186.0,
            "category": "Бонусы",
            "date": "16.06.2021",
